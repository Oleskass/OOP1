...
public class GameMain {
    // HW 6
    // 1. В проекте RobotMap сделать интерфейс для робота. Везде наружу (в метод #main)
    // отдавать интерфейс. Создание объекта конкретного класса должно быть ровно в
    // одном месте внутри класса RobotMap.
    // 2.* При желании, сделать рефакторинг проекта RobotMap, описать проделанную
    // работу и объяснить, какую пользу несут изменения.
        ...
        private void initCreateCommandHandler() {
            handlers.add(new CommandHandler() {
                ...
                public void handle(String[] args) {
                    ...
                    RobotInterface robot1 = map1.createRobot(new Point(x, y));
        ...
        private void initMoveCommandHandler() {
            handlers.add(new CommandHandler() {
                ...
                public void handle(String[] args) {
                    ...
                    Optional<RobotInterface> robot = map1.getById(robotId);
